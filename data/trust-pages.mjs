import { TRIAL_MILESTONE_COPY, TRIAL_MILESTONE_LASTMOD, trialNetworkCopy } from "./trial-milestone-copy.mjs";
...
networkTestPage.relatedLinks.push({
  label: "Measured local-engine check with network access denied",
  href: "/guides/mac-dictation-benchmark-method/#network-denial",
});
