...
export const OFFLINE_DICTATION_GUIDE_COPY = {
  en: {
    ...
    rows: [
      ...
      ["Voibe", "Only in On-Device Mode. Intel Macs use cloud transcription.", "It still collects account identifiers, usage analytics, and crash reports, but says dictated content is not included.", "Polished offline dictation for users who want a simple workflow."],
  ...
  de: {
    ...
    rows: [
      ...
      ["Voibe", "Nur im On-Device-Modus. Intel-Macs nutzen Cloud-Transkription.", "Erfasst weiterhin Konto-IDs, Nutzungsanalytik und Crash-Berichte, aber laut Anbieter keine diktierten Inhalte.", "Poliertes Offline-Diktat für einfache Workflows."],
  ...
  fr: {
    ...
    answer:
      "Pour une dictée Mac quotidienne et system-wide avec audio local, retenez Dictivo Local, VoiceInk, Voice Type et Voibe (mode local). Superwhisper peut aussi rester local s'il est configuré avec des modèles vocaux locaux. MacWhisper prend en charge la dictée et les fichiers ; Aiko traite les enregistrements. Wispr Flow n'est pas un choix hors ligne, car ses docs publiques décrivent une transcription cloud.",
    ...
    rows: [
      ...
      ["Voibe", "Uniquement en mode local. Les Mac Intel utilisent le cloud.", "Collecte encore des identifiants de compte, de l'analytique et des crash reports, sans contenu dicté selon le fournisseur.", "Dictée hors ligne polie pour workflow simple."],
  ...
  es: {
    ...
    rows: [
      ...
      ["Voibe", "Solo en modo local. Los Mac Intel usan transcripción en la nube.", "Aún recoge identificadores de cuenta, analítica y fallos, pero dice que no incluyen contenido dictado.", "Dictado offline pulido para workflow simple."],
  ...
  it: {
    ...
    answer:
      "Per dettatura Mac quotidiana e system-wide con audio locale, valuta Dictivo Local, VoiceInk, Voice Type e Voibe (modalità locale). Superwhisper può essere locale se configurato con modelli vocali locali. MacWhisper supporta dettatura e file; Aiko elabora registrazioni. Wispr Flow non è una scelta offline perché i suoi documenti pubblici descrivono trascrizione cloud.",
    ...
    rows: [
      ...
      ["Voibe", "Solo in modalità locale. I Mac Intel usano il cloud.", "Raccoglie ancora identificatori account, analytics e crash report, ma dice che non includono contenuto dettato.", "Dettatura offline rifinita per workflow semplice."],
  ...
  nl: {
    ...
    answer:
      "Voor dagelijkse system-wide Mac-dictatie met lokale audio staan Dictivo Local, VoiceInk, Voice Type en Voibe (lokale modus) bovenaan. Superwhisper kan ook lokaal zijn als je lokale spraakmodellen kiest. MacWhisper ondersteunt dictatie en bestanden; Aiko verwerkt opnames. Wispr Flow is geen offline keuze, omdat de publieke docs cloudtranscriptie beschrijven.",
    ...
    rows: [
      ...
      ["Voibe", "Alleen in de lokale modus. Intel-Macs gebruiken cloudtranscriptie.", "Verzamelt nog account-ID's, gebruiksanalytics en crashrapporten, maar zegt dat gedicteerde inhoud niet is inbegrepen.", "Gepolijste offline dictatie voor een eenvoudige workflow."],
  ...
  pt: {
    ...
    answer:
      "Para ditado diário no Mac com áudio local, considere Dictivo Local, VoiceInk, Voice Type e Voibe (modo local). Superwhisper também pode ser local se configurado com modelos de voz locais. MacWhisper suporta ditado e ficheiros; Aiko processa gravações. Wispr Flow não é uma opção offline porque seus docs públicos descrevem transcrição em nuvem.",
    ...
    rows: [
      ...
      ["Voibe", "Apenas no modo local. Os Macs Intel usam transcrição na nuvem.", "Ainda coleta identificadores de conta, analytics e crash reports, mas diz que não incluem conteúdo ditado.", "Ditado offline polido para workflow simples."],
  ...
  zh: {
    ...
    rows: [
      ...
      ["Voibe", "仅限本地模式；Intel Mac 使用云端转录。", "仍会收集账号标识、使用分析和崩溃报告，但称不包含听写内容。", "适合想要简单流程的精致离线听写。"],
  ...
  ko: {
    ...
    answerTitle: "짧은 답",
    answer:
      "일상적인 시스템 전체 Mac 받아쓰기에서 오디오를 로컬에 두고 싶다면 Dictivo Local, VoiceInk, Voice Type, Voibe (로컬 모드)를 먼저 비교하세요. Superwhisper도 로컬 음성 모델로 설정하면 로컬로 사용할 수 있습니다. MacWhisper는 받아쓰기와 파일을 모두 지원하며, Aiko는 녹음을 처리합니다. Wispr Flow는 공개 문서가 클라우드 전사를 설명하므로 오프라인 선택지는 아닙니다.",
    ...
    rows: [
      ...
      ["Voibe", "로컬 모드에서만 가능합니다. Intel Mac은 클라우드 전사를 사용합니다.", "계정 식별자, 사용 분석, 충돌 보고서는 수집하지만 받아쓴 내용은 포함하지 않는다고 합니다.", "단순한 워크플로를 원하는 사용자를 위한 다듬어진 오프라인 받아쓰기."],
