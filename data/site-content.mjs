...
const introUntil = (locale) => offerDate(LOCAL_OFFER.introPriceUntil, locale);
const regularFrom = (locale) => offerDate(LOCAL_OFFER.regularPriceFrom, locale);
...
export const HOME_COPY = {
    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          ...
          small: `one-time · introductory price until ${introUntil("en")}`,
          features: [
            ...
            "Optional update renewal after year one: {{price.renewal.inline}} a year",
    ...
    faq: {
      ...
      items: [
        ...
        [
          ...
          `No. Dictivo Local is {{price.local.inline}} once until ${introUntil("en")}, then {{price.regular.inline}} from ${regularFrom("en")}. The license is perpetual: the version you buy keeps working forever. After 12 months of included updates you can optionally renew for {{price.renewal.inline}} a year - or keep using what you have. Cloud Fast is a separate, optional add-on at {{price.cloudFast.inline}} a month.`,
        ],
        [
  ...
  de: {
    ...
    hero: {
      ...
      play: "20-Sekunden-Demo abspielen",
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: "Dictivo Local", sub: "Größere lokale Modelle und 12 Monate Updates freischalten.", small: `einmalig · Einführungspreis bis ${introUntil("de")}`, features: ["Dauerlizenz für die gekaufte Version", "12 Monate Updates und neue lokale Modelle", "Auf bis zu 3 persönlichen Geräten nutzbar", "Optionale Verlängerung für künftige Updates: {{price.renewal.inline}} pro Jahr", "14 Tage Erstattung ohne Fragen"], button: "Local kaufen" },
  ...
  fr: {
    ...
    hero: {
      ...
      play: "Lire la démo de 20 secondes",
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: "Dictivo Local", sub: "Débloquez les modèles locaux plus grands et 12 mois de mises à jour.", small: `paiement unique · prix de lancement jusqu'au ${introUntil("fr")}`, features: ["Licence perpétuelle pour la version achetée", "12 mois de mises à jour et nouveaux modèles locaux", "Jusqu'à 3 appareils personnels", "Renouvellement optionnel à {{price.renewal.inline}} par an", "Remboursement 14 jours, sans question"], button: "Acheter Local" },
        { name: "Cloud Fast", sub: "Ajoutez une transcription cloud rapide pour certains enregistrements.", small: "par mois", features: ["1 500 minutes de transcription par mois", "Seul ou avec Dictivo Local", "Un simple bouton Cloud Fast dans l'app", "N'envoie que les enregistrements choisis", "Dictionnaire local et extraits s'appliquent après le retour du texte"], button: "Ajouter Cloud Fast" },
      ],
  ...
  es: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: "Dictivo Local", sub: "Desbloquea modelos locales grandes y 12 meses de actualizaciones.", small: `pago único · precio de lanzamiento hasta el ${introUntil("es")}`, features: ["Licencia perpetua para la versión comprada", "12 meses de actualizaciones y nuevos modelos locales", "Uso en hasta 3 dispositivos personales", "Renovación opcional de {{price.renewal.inline}} al año", "Reembolso de 14 días, sin preguntas"], button: "Comprar Local" },
        { name: "Cloud Fast", sub: "Añade transcripción cloud rápida para grabaciones seleccionadas.", small: "al mes", features: ["1.500 minutos de transcripción al mes", "Solo o junto a Dictivo Local", "Un simple interruptor Cloud Fast en la app", "Sube solo las grabaciones que eliges", "Diccionario local y fragmentos se aplican al volver el texto"], button: "Añadir Cloud Fast" },
      ],
...
const italian = {
  ...
  hero: {
    ...
    play: "Riproduci demo di 20 secondi",
...
const dutch = {
  ...
  hero: {
    ...
    play: "Demo van 20 seconden afspelen",
...
const portuguese = {
  ...
  hero: {
    ...
    play: "Reproduzir demo de 20 segundos",
    ...
    pricing: {
      tiers: [
        ...
        },
        {
          ...
          small: `una tantum · prezzo di lancio fino al ${introUntil("it")}`,
          features: [
            ...
            "Rinnovo opzionale da {{price.renewal.inline}} all'anno per aggiornamenti futuri",
  ...
  nl: {
    ...
    pricing: {
      tiers: [
        ...
        { name: "Dictivo Local", sub: "Ontgrendel grotere lokale modellen en 12 maanden updates.", small: `eenmalig · introductieprijs t/m ${introUntil("nl")}`, features: ["Permanente licentie voor de gekochte versie", "12 maanden updates en nieuwe lokale modellen", "Gebruik op maximaal 3 persoonlijke apparaten", "Optionele verlenging van {{price.renewal.inline}} per jaar voor toekomstige updates", "14 dagen terugbetaling, zonder vragen"], button: "Local kopen" },
  ...
  pt: {
    ...
    pricing: {
      tiers: [
        ...
        { name: "Dictivo Local", sub: "Desbloqueie modelos locais maiores e 12 meses de atualizações.", small: `pagamento único · preço de lançamento até ${introUntil("pt")}`, features: ["Licença perpétua para a versão comprada", "12 meses de atualizações e novos modelos locais", "Use em até 3 dispositivos pessoais", "Renovação opcional de {{price.renewal.inline}} por ano para futuras atualizações", "Reembolso de 14 dias, sem perguntas"], button: "Comprar Local" },
  ...
  zh: {
    ...
    pricing: {
      tiers: [
        ...
        { name: "Dictivo Local", sub: "解锁更大的本地模型和 12 个月更新。", small: `一次买断 · 启动价截至 ${introUntil("zh")}`, features: ["购买版本的永久许可证", "12 个月更新和新的本地模型", "最多可在 3 台个人设备使用", "未来更新可选续订，每年 {{price.renewal.inline}}", "14 天无理由退款"], button: "购买 Local" },
  ...
  ja: {
    ...
    pricing: {
      tiers: [
        ...
        { name: "Dictivo Local", sub: "より大きなローカルモデルと 12 か月のアップデートを利用できます。", small: `買い切り · ${introUntil("ja")}までのローンチ価格`, features: ["購入したバージョンの永続ライセンス", "12 か月のアップデートと新しいローカルモデル", "個人用デバイス最大 3 台で利用可能", "将来の更新は任意：年 {{price.renewal.inline}}", "14 日間返金、理由は不要"], button: "Local を購入" },
  ...
  ko: {
    ...
    pricing: {
      tiers: [
        ...
        { name: "Dictivo Local", sub: "더 큰 로컬 모델과 12개월 업데이트를 잠금 해제합니다.", small: `일회성 · ${introUntil("ko")}까지 런칭 가격`, features: ["구매한 버전의 영구 라이선스", "12개월 업데이트와 새 로컬 모델", "개인 기기 최대 3대에서 사용", "향후 업데이트는 선택적으로 연 {{price.renewal.inline}}에 갱신", "14일 환불, 질문 없음"], button: "Local 구매" },
...
/**
 * Parity pass for the nine localized homepages (2026-08-01).
 *
 * Each locale carried six FAQ entries against the English page's nine, and an
 * older three-card trust block against the English four. The three missing
 * answers are the ones that close a sale — that Local is not a subscription,
 * how to prove Local uploads nothing, and what happens if it does not fit.
 *
 * Copy was drafted per locale and then revised by a second native pass; the
 * revisions are already folded in here. signed.title and signed.footnote are
 * deliberately absent: WINDOWS_HOME_COPY in the generator already overrides
 * both per locale, so setting them here would be dead weight.
 */
const L10N_PARITY = {
  de: {
    faq: [
      ["Ist das ein Abo?", `Nein. Dictivo Local kostet bis zum ${introUntil("de")} einmalig {{price.local.inline}}, ab dem ${regularFrom("de")} kostet Dictivo Local {{price.regular.inline}}, ebenfalls einmalig. Die Lizenz gilt dauerhaft: Die gekaufte Version läuft unbegrenzt weiter. Die ersten 12 Monate Updates sind enthalten; danach können Sie optional für {{price.renewal.inline}} pro Jahr verlängern - oder einfach mit Ihrer Version weiterarbeiten. Cloud Fast ist ein separates, optionales Add-on für {{price.cloudFast.inline}} pro Monat.`],
    ...
    signedCells: [
      ["Selbst nachprüfen", "Führen Sie den offenen Netzwerktest durch: Diktieren Sie im lokalen Modus und sehen Sie selbst, dass kein Audio Ihr Gerät verlässt"],
      ["Nativ und notarisiert", "Auf macOS von Apple notarisiert, ein Download von {dmgSizeMb} MB - mit signierten automatischen Updates"],
  ...
  fr: {
    faq: [
      ["Est-ce un abonnement?", `Non. Dictivo Local est un paiement unique de {{price.local.inline}} jusqu'au ${introUntil("fr")}, puis de {{price.regular.inline}} à partir du ${regularFrom("fr")}. La licence est perpétuelle : la version achetée continue de fonctionner indéfiniment. Après 12 mois de mises à jour incluses, vous pouvez renouveler pour {{price.renewal.inline}} par an - ou simplement continuer avec ce que vous avez. Cloud Fast est une option séparée à {{price.cloudFast.inline}} par mois.`],
    ...
    signedCells: [
      ["Vérifiez par vous-même", "Faites le test réseau vous-même : dictez en mode Local et constatez qu'aucun audio ne quitte votre appareil"],
      ["Natif et notarisé", "Notarisé sur macOS - {dmgSizeMb} Mo à télécharger, avec mises à jour automatiques signées"],
  ...
  es: {
    faq: [
      ["¿Es una suscripción?", `No. Dictivo Local cuesta {{price.local.inline}} una sola vez hasta el ${introUntil("es")} y {{price.regular.inline}} a partir del ${regularFrom("es")}. La licencia es perpetua: la versión que compras sigue funcionando para siempre. Después de los 12 meses de actualizaciones incluidas puedes renovar opcionalmente por {{price.renewal.inline}} al año - o seguir usando lo que ya tienes. Cloud Fast es un complemento opcional aparte, por {{price.cloudFast.inline}} al mes.`],
    ...
    signedCells: [
      ["Compruébalo tú mismo", "Haz la prueba de red: dicta en modo Local con un monitor de red abierto y comprueba que no sale audio de tu dispositivo"],
      ["Nativa y notarizada", "Notarizada en macOS, una descarga de {dmgSizeMb} MB - con actualizaciones automáticas firmadas"],
  ...
  it: {
    faq: [
      ["È un abbonamento?", `No. Dictivo Local costa {{price.local.inline}} una tantum fino al ${introUntil("it")}, poi {{price.regular.inline}} dal ${regularFrom("it")}. La licenza è perpetua: la versione che acquisti continua a funzionare per sempre. Dopo i 12 mesi di aggiornamenti inclusi puoi rinnovare a {{price.renewal.inline}} all'anno, oppure continuare a usare quello che hai. Cloud Fast è un componente aggiuntivo separato e opzionale a {{price.cloudFast.inline}} al mese.`],
    ...
    signedCells: [
      ["Verificalo tu stesso", "Esegui il test di rete aperto: detta in modalità Local e osserva che nessun audio lascia il tuo dispositivo"],
      ["App nativa e notarizzata", "Notarizzata su macOS, download da {dmgSizeMb} MB con aggiornamenti automatici firmati"],
  ...
  nl: {
    faq: [
      ["Is dit een abonnement?", `Nee. Dictivo Local kost eenmalig {{price.local.inline}} tot en met ${introUntil("nl")} en {{price.regular.inline}} vanaf ${regularFrom("nl")}. De licentie is permanent: de versie die je koopt blijft altijd werken. Na de 12 maanden inbegrepen updates kun je optioneel verlengen voor {{price.renewal.inline}} per jaar - of gewoon verder met wat je hebt. Cloud Fast is een aparte, optionele add-on van {{price.cloudFast.inline}} per maand.`],
    ...
    signedCells: [
      ["Controleer het zelf", "Voer de open netwerktest uit: dicteer in Local-modus en je ziet dat er geen audio je apparaat verlaat"],
      ["Native en genotariseerd", "Door Apple genotariseerd op macOS, een download van {dmgSizeMb} MB - met ondertekende automatische updates"],
  ...
  pt: {
    faq: [
      ["Isso é uma assinatura?", `Não. Dictivo Local custa {{price.local.inline}} uma vez até ${introUntil("pt")} e {{price.regular.inline}} a partir de ${regularFrom("pt")}. A licença é perpétua: a versão que você comprar continua funcionando para sempre. Depois dos 12 meses de atualizações incluídas, você pode renovar por {{price.renewal.inline}} por ano se quiser - ou continuar com o que já tem. O Cloud Fast é um complemento opcional à parte, por {{price.cloudFast.inline}} por mês.`],
    ...
    signedCells: [
      ["Verifique você mesmo", "Faça o teste de rede aberto: dite no modo Local e veja que nenhum áudio sai do seu dispositivo"],
      ["Nativo e notarizado", "Notarizado pela Apple no macOS, download de {dmgSizeMb} MB - com atualizações automáticas assinadas"],
  ...
  zh: {
    faq: [
      ["这是订阅制吗？", `不是。Dictivo Local 截至 ${introUntil("zh")} 一次买断 {{price.local.inline}}，${regularFrom("zh")} 起为 {{price.regular.inline}}。许可证永久有效：你买到的那个版本可以一直用下去。包含的 12 个月更新期结束后，可以选择每年 {{price.renewal.inline}} 续订，也可以继续使用手上的版本。 Cloud Fast 是单独的可选附加服务，每月 {{price.cloudFast.inline}}。`],
      ["我怎么验证本地模式确实没有上传？", "运行公开网络测试：打开系统网络监控工具，用本地模式听写，观察有没有对外流量。隐私证明页面上有分步指南。"],
      ["如果不适合我的工作流怎么办？", "每笔购买都有 14 天无理由退款；无论如何，Tiny Local 听写都永久免费。"],
    ],
    signedCells: [
      ["自己动手验证", "运行公开网络测试：用本地模式听写，确认没有音频离开你的设备"],
      ["原生应用，已公证", "macOS 版经 Apple 公证，安装包 {dmgSizeMb} MB - 自动更新同样带签名"],
      ["永不需要账号", "本地模式从不索取邮箱，也不需要登录"],
      ["零风险", "购买后 14 天无理由退款，Tiny 永久免费"],
    ],
    tierSub: "拥有全部本地模型 - 一次买断，不是订阅。",
  },
  ja: {
    faq: [
      ["これはサブスクリプションですか？", `いいえ。Dictivo Local は ${introUntil("ja")}まで {{price.local.inline}} の買い切りで、${regularFrom("ja")}より {{price.regular.inline}} に改定予定です。ライセンスは永続で、購入したバージョンはずっと使い続けられます。12 か月のアップデート期間が終わったあとは、アップデートを受け取り続けたい場合のみ任意で年 {{price.renewal.inline}} で更新できます。更新しない場合も、手元のバージョンはそのまま使えます。 Cloud Fast は別売りのオプションで、月額 {{price.cloudFast.inline}} です。`],
    ...
    signedCells: [
      ["自分で検証できます", "公開ネットワークテストを実行すれば、Local モードの音声入力で音声が一切デバイスから出ないことを確認できます"],
      ["ネイティブアプリ", "macOS 版は公証済みで、ダウンロードは {dmgSizeMb} MB - 自動アップデートも署名付きです"],
      ["アカウントは一切不要", "Local モードがメールアドレスやログインを求めることはありません"],
      ["リスクなし", "購入には 14 日間の返金保証が付き、Tiny は永久無料のままです"],
    ],
    tierSub: "すべてのローカルモデルを買い切りで利用できます - サブスクリプションではありません。",
  },
  ko: {
    faq: [
      ["구독인가요?", `아니요. Dictivo Local은 ${introUntil("ko")}까지 {{price.local.inline}} 한 번 결제이며, ${regularFrom("ko")}부터 {{price.regular.inline}}입니다. 라이선스는 영구적이라 구매한 버전은 계속 사용할 수 있습니다. 포함된 12개월 업데이트 기간이 끝난 뒤에는 원하면 연 {{price.renewal.inline}}에 갱신하거나, 쓰던 버전을 그대로 사용하면 됩니다. Cloud Fast는 별도의 선택 사항으로 월 {{price.cloudFast.inline}}입니다.`],
    ...
    signedCells: [
      ["직접 확인", "공개 네트워크 테스트로 Local 모드에서 오디오가 기기 밖으로 나가지 않는지 확인할 수 있습니다"],
      ["네이티브 앱, 공증 완료", "macOS에서 공증된 {dmgSizeMb} MB 설치 파일이며 자동 업데이트도 서명됩니다"],
...
for (const [localeCode, copy] of Object.entries(L10N_PARITY)) {
  const target = HOME_COPY[localeCode];
  if (!target) continue;
  target.faq.items = [...target.faq.items, ...copy.faq];
  target.signed.cells = copy.signedCells;
  target.signed.footnoteHref = "/privacy/local-dictation-network-test/";
  target.pricing.tiers[1].sub = copy.tierSub;
}
