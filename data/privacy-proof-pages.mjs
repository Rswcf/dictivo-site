import { TRIAL_MILESTONE_COPY, TRIAL_MILESTONE_LASTMOD } from "./trial-milestone-copy.mjs";
export const PRIVACY_PROOF_LASTMOD = TRIAL_MILESTONE_LASTMOD;
...
export const PRIVACY_PROOF_COPY = {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast uploads only recordings you choose to send through Cloud Fast.", TRIAL_MILESTONE_COPY.en.usage + " " + TRIAL_MILESTONE_COPY.en.trial,
        ],
      },
      {
        title: "Cloud Fast",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast lädt nur Aufnahmen hoch, die Sie über Cloud Fast senden.", TRIAL_MILESTONE_COPY.de.usage + " " + TRIAL_MILESTONE_COPY.de.trial,
        ],
      },
      {
        title: "Cloud Fast",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast envoie uniquement les enregistrements choisis pour Cloud Fast.", TRIAL_MILESTONE_COPY.fr.usage + " " + TRIAL_MILESTONE_COPY.fr.trial,
        ],
      },
      {
        title: "Cloud Fast",
  ...
  es: {
    ...
    answer:
      "En el modo Local de Dictivo, el audio del micrófono, las transcripciones, el historial, los términos del diccionario, los fragmentos, los ajustes y la elección de modelos locales permanecen en el dispositivo. Dictivo usa la red para actualizaciones, licencias o pagos, soporte y Cloud Fast opcional. Cloud Fast sube solo la grabación que envías por ese modo. " + TRIAL_MILESTONE_COPY.es.usage + " " + TRIAL_MILESTONE_COPY.es.trial,
    sections: [
      {
        title: "Modo Local",
        paragraphs: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast sube solo grabaciones que envías por Cloud Fast.", TRIAL_MILESTONE_COPY.es.usage + " " + TRIAL_MILESTONE_COPY.es.trial,
        ],
      },
      {
        title: "Cloud Fast",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast carica solo registrazioni che invii tramite Cloud Fast.", TRIAL_MILESTONE_COPY.it.usage + " " + TRIAL_MILESTONE_COPY.it.trial,
        ],
      },
      {
        title: "Cloud Fast",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast uploadt alleen opnames die je via Cloud Fast verstuurt.", TRIAL_MILESTONE_COPY.nl.usage + " " + TRIAL_MILESTONE_COPY.nl.trial,
        ],
      },
      {
        title: "Cloud Fast",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast envia apenas gravações que você manda pelo Cloud Fast.", TRIAL_MILESTONE_COPY.pt.usage + " " + TRIAL_MILESTONE_COPY.pt.trial,
        ],
      },
      {
        title: "Cloud Fast",
  ...
  zh: {
    ...
    answer:
      "在 Dictivo Local 模式下，麦克风音频、转录文本、历史记录、词典条目、文本片段、设置和本地模型选择都会留在本设备。Dictivo 会为了更新检查、许可证或支付操作、支持服务和可选 Cloud Fast 使用网络。Cloud Fast 只上传你通过该模式发送的那段录音。 " + TRIAL_MILESTONE_COPY.zh.usage + " " + TRIAL_MILESTONE_COPY.zh.trial,
    sections: [
      {
        title: "Local 模式",
        paragraphs: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "支持邮件只会在你主动联系支持时发生。",
          "Cloud Fast 只上传你主动通过 Cloud Fast 发送的录音。", TRIAL_MILESTONE_COPY.zh.usage + " " + TRIAL_MILESTONE_COPY.zh.trial,
        ],
      },
      {
        title: "Cloud Fast",
  ...
  ja: {
    ...
    answer:
      "Dictivo の Local モードでは、マイク音声、文字起こし、履歴、辞書語句、スニペット、設定、ローカルモデル選択がデバイス上に残ります。Dictivo は更新確認、ライセンスや支払い、サポート、任意の Cloud Fast にネットワークを使います。Cloud Fast はそのモードで送信した録音だけをアップロードします。 " + TRIAL_MILESTONE_COPY.ja.usage + " " + TRIAL_MILESTONE_COPY.ja.trial,
    sections: [
      {
        title: "Local モード",
        paragraphs: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast は Cloud Fast で送った録音だけをアップロードします。", TRIAL_MILESTONE_COPY.ja.usage + " " + TRIAL_MILESTONE_COPY.ja.trial,
        ],
      },
      {
        title: "Cloud Fast",
  ...
  ko: {
    ...
    answer:
      "Dictivo Local 모드에서는 마이크 오디오, 전사문, 기록, 사전 용어, 스니펫, 설정, 로컬 모델 선택이 기기에 남습니다. Dictivo는 업데이트 확인, 라이선스 또는 결제 작업, 지원, 선택형 Cloud Fast에 네트워크를 사용합니다. Cloud Fast는 해당 모드로 보낸 녹음만 업로드합니다. " + TRIAL_MILESTONE_COPY.ko.usage + " " + TRIAL_MILESTONE_COPY.ko.trial,
    sections: [
      {
        title: "Local 모드",
        paragraphs: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Cloud Fast는 Cloud Fast로 보낸 녹음만 업로드합니다.", TRIAL_MILESTONE_COPY.ko.usage + " " + TRIAL_MILESTONE_COPY.ko.trial,
        ],
      },
      {
        title: "Cloud Fast",
