...
export const COMPARE_SELECTION_GUIDES = {
  fr: {
    ...
    steps: [
      ...
      ["Quel résultat obtenez-vous pendant l’essai ?", "Dictez un court e-mail avec des noms propres et de la ponctuation. Relisez-le, corrigez-le et comparez le temps nécessaire avec votre méthode habituelle. Tous les modèles Local sont disponibles pendant l’essai de 14 jours. Ensuite, Tiny reste gratuit sans limite de durée ; une licence Dictivo Local débloque les modèles plus grands. Cloud Fast a son propre abonnement."],
    ],
  ...
  ja: {
    ...
    steps: [
      ...
      ["無料の範囲と実際の修正量を確かめる", "固有名詞や句読点を含む短いメールを話し、読み直して修正してください。いつもの書き方と比べ、完成までの手間を確認しましょう。すべてのLocalモデルを14日間試せます。試用終了後もTinyは無料で使えます。より大きいモデルを使うにはDictivo Localライセンスの購入が必要です。Cloud Fastは別のサブスクリプションです。"],
    ],
  ...
  de: {
    ...
    steps: [
      ...
      ["Wie viel Nacharbeit bleibt im Test?", "Diktieren Sie eine kurze E-Mail mit Eigennamen und Satzzeichen. Lesen und korrigieren Sie den Text und vergleichen Sie den Aufwand mit Ihrer bisherigen Methode. Alle Local-Modelle sind 14 Tage testbar. Danach bleibt Tiny dauerhaft kostenlos; eine Dictivo-Local-Lizenz schaltet die größeren Modelle frei. Cloud Fast hat ein separates Abonnement."],
    ],
