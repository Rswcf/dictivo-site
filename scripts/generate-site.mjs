...
const WINDOWS_HOME_COPY = {
  en: {
    metaTitle: "Offline Dictation App for Mac & Windows - Buy Once | Dictivo",
    ...
    metaDescription:
      "Dictivo types what you say into any Mac or Windows app. Local mode keeps audio on your device - verify it with an open network test. Buy once, yours to keep.",
  },
  de: {
    metaTitle: "Offline-Diktier-App für Mac & Windows - einmal kaufen | Dictivo",
    navDownload: "Downloads",
    ...
    metaDescription:
      "Dictivo tippt, was Sie sagen - in jeder Mac- und Windows-App. Lokal bleibt Audio auf Ihrem Gerät, per offenem Netzwerktest überprüfbar. Einmal kaufen, für immer Ihres.",
  },
  fr: {
    metaTitle: "App de dictée hors ligne pour Mac et Windows - achat unique | Dictivo",
    ...
    metaDescription:
      "Dictivo tape ce que vous dictez dans toute app Mac ou Windows. En local, l'audio reste sur votre appareil, vérifiable par test réseau. Achat unique, à vous pour toujours.",
  },
  es: {
    ...
    metaDescription:
      "Dictivo escribe lo que dictas en cualquier app de Mac o Windows. En modo local, el audio se queda en tu equipo. Un solo pago y es tuyo para siempre.",
  },
  it: {
    metaTitle: "App di dettatura offline per Mac e Windows - acquisto unico | Dictivo",
    ...
    metaDescription:
      "Dictivo scrive ciò che detti in qualsiasi app per Mac o Windows. In modalità locale l'audio resta sul tuo dispositivo. Un solo acquisto, ed è tuo per sempre.",
  },
  nl: {
    metaTitle: "Offline dicteer-app voor Mac en Windows - eenmalig kopen | Dictivo",
    navDownload: "Downloads",
...
const SEO_HOME_COPY = {
  en: {
    metaTitle: "Dictivo - Private Mac dictation. Buy once, yours to keep",
    metaDescription:
      "Press one hotkey and Dictivo types what you say into any Mac app. Local mode keeps audio on your device - verify it yourself with an open network test. Buy once, yours to keep. Optional Cloud Fast when speed matters more.",
    heroTitle: "Dictation that stays on your Mac.",
    heroEmphasis: "Buy once, own it.",
    heroEyebrow: "Private Mac dictation app",
    footerPrivacyProof: "Privacy proof",
  },
  de: {
    metaTitle: "Dictivo - Privates Mac-Diktat. Einmal kaufen, für immer Ihres",
    metaDescription:
      "Ein Hotkey, und Dictivo tippt, was Sie sagen - in jeder Mac-App. Im Local-Modus bleibt Audio auf Ihrem Gerät, überprüfbar per offenem Netzwerktest. Einmal kaufen, für immer Ihres. Optional Cloud Fast, wenn Tempo wichtiger ist.",
    heroTitle: "Diktieren, das auf Ihrem Mac bleibt.",
    heroEmphasis: "Einmal kaufen, für immer Ihres.",
    heroEyebrow: "Private Mac-Diktat-App",
    footerPrivacyProof: "Datenschutznachweis",
  },
  fr: {
    metaTitle: "Dictivo - Dictée Mac privée. Achat unique, à vous pour toujours",
    metaDescription:
      "Un raccourci, et Dictivo tape ce que vous dites dans n'importe quelle app Mac. Le mode Local garde l'audio sur votre appareil, vérifiable par un test réseau ouvert. Achat unique, à vous pour toujours. Cloud Fast en option quand la vitesse prime.",
    heroTitle: "La dictée qui reste sur votre Mac.",
    heroEmphasis: "Achetez une fois, gardez-le.",
    heroEyebrow: "App de dictée Mac privée",
    footerPrivacyProof: "Preuve confidentialité",
  },
  es: {
    metaTitle: "Dictivo - Dictado privado para Mac. Un solo pago y es tuyo para siempre",
    metaDescription:
      "Pulsa un atajo y Dictivo escribe lo que dices en cualquier app del Mac. El modo Local mantiene el audio en tu equipo, verificable con un test de red abierto. Un solo pago y es tuyo para siempre. Cloud Fast opcional cuando importa la velocidad.",
    heroTitle: "Dictado que se queda en tu Mac.",
    heroEmphasis: "Compra una vez y es tuyo.",
    heroEyebrow: "App de dictado privado para Mac",
    footerPrivacyProof: "Prueba de privacidad",
  },
  it: {
    metaTitle: "Dictivo - Dettatura privata per Mac. Un solo acquisto, ed è tuo per sempre",
    metaDescription:
      "Premi una scorciatoia e Dictivo scrive ciò che dici in qualsiasi app del Mac. La modalità Local tiene l'audio sul tuo dispositivo, verificabile con un test di rete aperto. Un solo acquisto, ed è tuo per sempre. Cloud Fast opzionale quando conta la velocità.",
    heroTitle: "La dettatura che resta sul tuo Mac.",
    heroEmphasis: "Compra una volta, è tuo.",
    heroEyebrow: "App di dettatura privata per Mac",
    footerPrivacyProof: "Prova privacy",
  },
  nl: {
    metaTitle: "Dictivo - Private Mac-dictatie. Eenmalig kopen, voor altijd van jou",
    metaDescription:
      "Eén sneltoets en Dictivo typt wat je zegt in elke Mac-app. Local-modus houdt audio op je apparaat, controleerbaar met een open netwerktest. Eenmalig kopen, voor altijd van jou. Optionele Cloud Fast wanneer snelheid telt.",
    heroTitle: "Dictatie die op je Mac blijft.",
    heroEmphasis: "Eén keer kopen, voor altijd van jou.",
  ...
  ja: {
    metaTitle: "Dictivo - プライベート Mac 音声入力。買い切りで、ずっと使えます",
    metaDescription:
      "ホットキーを押して話すだけで、Dictivo がどの Mac アプリにも文字を入力します。Local モードでは音声がデバイスに留まり、公開ネットワークテストで検証できます。買い切りで、ずっと使えます。速度重視のときは Cloud Fast も選べます。",
    heroTitle: "音声が Mac の外に出ない音声入力。",
    heroEmphasis: "買い切り。ずっと使えます。",
...
const COMPARE_I18N = {
  en: {
    ...
    quickTake: [
      ...
      ["Dictivo model", "{{price.local.inline}} once, Tiny free forever, 14-day full Local trial", "See {competitor} pricing and trial notes below"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} once, 12 months of updates, then optional update renewal at {{price.renewal.inline}} a year.",
      "Free tier / trial":
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local is {{price.local.inline}} once, with optional update renewals after the first year.",
    ...
    ctaBody:
      "Every local model unlocked, no Dictivo account for Local mode. Buy Local for {{price.local.inline}} once if it fits your workflow.",
  ...
  de: {
    ...
    quickTake: [
      ...
      ["Dictivo-Modell", "{{price.local.inline}} einmalig, Tiny dauerhaft gratis, 14 Tage voller Local-Test", "Siehe Preis- und Testnotizen unten"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} einmalig, 12 Monate Updates, danach optionale Verlängerung für {{price.renewal.inline}} pro Jahr.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local kostet {{price.local.inline}} einmalig, mit optionaler Update-Verlängerung nach dem ersten Jahr.",
    ...
    ctaBody: "Alle lokalen Modelle entsperrt, kein Dictivo-Konto für Local mode. Dictivo Local kostet {{price.local.inline}} einmalig, wenn es passt.",
  ...
  fr: {
    ...
    quickTake: [
      ...
      ["Modèle Dictivo", "{{price.local.inline}} une fois, Tiny gratuit à vie, essai Local complet 14 jours", "Voir les notes de prix et d'essai ci-dessous"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} une fois, 12 mois de mises à jour, puis renouvellement optionnel à {{price.renewal.inline}} par an.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local coûte {{price.local.inline}} une fois, avec renouvellement de mises à jour optionnel après un an.",
    ...
    ctaBody: "Tous les modèles locaux sont déverrouillés, sans compte Dictivo pour le mode Local. Dictivo Local coûte {{price.local.inline}} une fois si cela vous convient.",
...
Object.assign(COMPARE_I18N, {
  es: compactCompareLocale({
    ...
    quickTake: [
      ...
      ["Modelo de Dictivo", "{{price.local.inline}} una vez, Tiny gratis para siempre, prueba Local completa de 14 días", "Ver notas de precio y prueba abajo"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} una vez, 12 meses de actualizaciones y renovación opcional de {{price.renewal.inline}} al año.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local cuesta {{price.local.inline}} una vez, con renovación opcional de actualizaciones después del primer año.",
    ...
    ctaBody: "Todos los modelos locales desbloqueados, sin cuenta de Dictivo para Local. Dictivo Local cuesta {{price.local.inline}} una vez si encaja con tu flujo.",
  ...
  zh: compactCompareLocale({
    ...
    quickTake: [
      ...
      ["Dictivo 模式", "{{price.local.inline}} 一次买断，Tiny 永久免费，14 天完整 Local 试用", "见下方价格与试用说明"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} 一次买断，含 12 个月更新，之后可选更新续费，每年 {{price.renewal.inline}}。",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local 是 {{price.local.inline}} 一次买断，第一年后可选更新续费。",
    ...
    ctaBody: "所有本地模型解锁，Local 模式不需要 Dictivo 账号。如果适合你的工作流，Dictivo Local {{price.local.inline}} 一次买断。",
...
Object.assign(COMPARE_I18N, {
  it: compactCompareLocale({
    ...
    quickTake: [
      ...
      ["Modello Dictivo", "{{price.local.inline}} una volta, Tiny gratis per sempre, prova Local completa di 14 giorni", "Vedi note su prezzi e prova sotto"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} una volta, 12 mesi di aggiornamenti, poi rinnovo opzionale da {{price.renewal.inline}} all'anno.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local costa {{price.local.inline}} una volta, con rinnovi opzionali degli aggiornamenti dopo il primo anno.",
    ...
    ctaBody: "Tutti i modelli locali sbloccati, senza account Dictivo per Local. Dictivo Local costa {{price.local.inline}} una volta se si adatta al tuo flusso.",
  ...
  nl: compactCompareLocale({
    ...
    quickTake: [
      ...
      ["Dictivo-model", "{{price.local.inline}} eenmalig, Tiny altijd gratis, 14 dagen volledige Local-proef", "Zie prijs- en proefnotities hieronder"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} eenmalig, 12 maanden updates, daarna optionele verlenging van {{price.renewal.inline}} per jaar.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local kost {{price.local.inline}} eenmalig, met optionele updateverlenging na het eerste jaar.",
    ...
    ctaBody: "Alle lokale modellen ontgrendeld, geen Dictivo-account voor Local. Dictivo Local kost {{price.local.inline}} eenmalig als het past.",
  ...
  pt: compactCompareLocale({
    ...
    quickTake: [
      ...
      ["Modelo Dictivo", "{{price.local.inline}} uma vez, Tiny grátis para sempre, teste Local completo de 14 dias", "Veja notas de preço e teste abaixo"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} uma vez, 12 meses de atualizações e renovação opcional de {{price.renewal.inline}} por ano.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local custa {{price.local.inline}} uma vez, com renovação opcional de atualizações após o primeiro ano.",
    ...
    ctaBody: "Todos os modelos locais desbloqueados, sem conta Dictivo para Local. Dictivo Local custa {{price.local.inline}} uma vez se fizer sentido.",
  ...
  ja: compactCompareLocale({
    ...
    quickTake: [
      ...
      ["Dictivo の形", "{{price.local.inline}} 買い切り、Tiny は永久無料、14 日間の完全 Local トライアル", "価格とトライアルの注記は下を参照"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} 買い切り、12 か月のアップデート、その後は任意で年 {{price.renewal.inline}} の更新。",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local は {{price.local.inline}} 買い切りで、1 年後のアップデート更新は任意です。",
    ...
    ctaBody: "すべてのローカルモデルを利用可能。Local には Dictivo アカウント不要。合えば Dictivo Local は {{price.local.inline}} 買い切りです。",
  ...
  ko: compactCompareLocale({
    ...
    quickTake: [
      ...
      ["Dictivo 모델", "{{price.local.inline}} 일회 구매, Tiny 영구 무료, 14일 전체 Local 체험", "아래 가격과 체험 정보 참고"],
    ...
    dictivoRows: {
      ...
      "Pricing model": "{{price.local.inline}} 일회 구매, 12개월 업데이트, 이후 선택적으로 연 {{price.renewal.inline}}에 업데이트 갱신.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Dictivo Local은 {{price.local.inline}} 일회 구매이며, 첫해 이후 업데이트 갱신은 선택 사항입니다.",
    ...
    ctaBody: "모든 로컬 모델이 열리고, Local에는 Dictivo 계정이 필요 없습니다. 맞는다면 Dictivo Local은 {{price.local.inline}} 일회 구매입니다.",
        ...
        <div class="section-shell">
          ...
          <div class="download-grid" data-layout="${hasWindowsRelease ? "multi" : "single"}" aria-label="${attr(t.downloads.available)}">
            ...
            ${hasWindowsRelease ? `<article class="download-card" data-platform-card="windows">
              ...
              <p class="download-note">${html(liveWindowsCopy.smartscreen)}</p>
            </article>` : ""}
          </div>
        </div>
      </section>
...
write("_routes.json", `${JSON.stringify(buildRoutesConfig(localeRoutes, languageChoicePaths(outDir)), null, 2)}\n`);
