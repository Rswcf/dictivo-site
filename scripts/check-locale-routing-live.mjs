...
await expect("?lang= works on pages outside translated sections", visit("/media-kit/?lang=en", { headers: { "sec-fetch-site": "same-origin" } }), (r) => [status(r, 302), location(r, "/media-kit/"), header(r, "set-cookie", /^dictivo_lang=en;/)]);
